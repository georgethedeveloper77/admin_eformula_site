    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-9 py-4">
                <div class="card p-3">
                    <h3 class="text-center">Elite Quiz Installer | <a style="color:red;" href="https://wa.me/919822491553" target="_blank">Please ping me on WhatsApp for more scripts</a></h3>
                    <hr>
                    <?php
                                ...
                                <div id="step-2">
                                    <div class="col-md-12">
                                        <div class="outer_div">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    <label>Purchase Code <small class="text-danger">Omkar nulled</small></label>
